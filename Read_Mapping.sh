...
INPUTDIR="/scratch/bnp34716/Sunflower/Trimmed2" #where the trimmed reads are

OUTPUTDIR="/scratch/bnp34716/Sunflower/Mapped2" #where to put the trimmed sequences
